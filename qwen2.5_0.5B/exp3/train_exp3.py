...
def train_stackelberg(
    ...
    # ── Model (SDPA) ──
    # Pas besoin d'eager : les cartes d'attention pour div/conf sont reconstruites
    # manuellement par get_attention_maps (_A/_AZ) depuis q/k/v_proj + hidden capturé,
    # indépendamment de l'implémentation d'attention. SDPA accélère le forward CE
    # (~30-50%) sur les 24 couches ; la reconstruction ne coûte qu'1 couche.
